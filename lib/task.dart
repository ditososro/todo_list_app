...
class Task {
  ...
  Task({this.name, this.todoDate, this.todoTime, this.colorTag, this.isFinalized, this.description });
  Task.withId({this.id, this.name, this.todoTime, this.todoDate, this.colorTag, this.isFinalized, this.description});

  Color getColor(){
    if (colorTag == GREEN_COLOR){
      return Colors.green[700];
    }
    else if (colorTag == Task.ORANGE_COLOR){
